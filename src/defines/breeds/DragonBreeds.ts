...
let DragonBreeds: Array<Breed> = [
    ...
    new DragonBreed("xenowyrm-aquilo", "Xenowyrm (Aquilo)", DragonSubType.Wyrm, [Affinity.Air], PortraitFactory.uPortraits("xenowyrm-aquilo")),
    new DragonBreed("xenowyrm-aso", "Xenowyrm (Aso)", DragonSubType.Wyrm, [Affinity.Ice], PortraitFactory.uPortraits("xenowyrm-aso")),
    new DragonBreed("xenowyrm-astrapi", "Xenowyrm (Astrapi)", DragonSubType.Wyrm, [Affinity.Lightning], PortraitFactory.uPortraits("xenowyrm-astrapi")),
    new DragonBreed("xenowyrm-chrono", "Xenowyrm (Chrono)", DragonSubType.Wyrm, [Affinity.Time], PortraitFactory.uPortraits("xenowyrm-chrono")),
    new DragonBreed("xenowyrm-gaia", "Xenowyrm (Gaia)", DragonSubType.Wyrm, [Affinity.Life], PortraitFactory.uPortraits("xenowyrm-gaia")),
    new DragonBreed("xenowyrm-kemaro", "Xenowyrm (Ke'maro)", DragonSubType.Wyrm, [Affinity.Death], PortraitFactory.uPortraits("xenowyrm-kemaro")),
    new DragonBreed("xenowyrm-mageia", "Xenowyrm (Mageia)", DragonSubType.Wyrm, [Affinity.Magi], PortraitFactory.uPortraits("xenowyrm-mageia")),
    new DragonBreed("xenowyrm-obidar", "Xenowyrm (Obidar)", DragonSubType.Wyrm, [Affinity.Earth], PortraitFactory.uPortraits("xenowyrm-obidar")),
    new DragonBreed("xenowyrm-pharos", "Xenowyrm (Pharos)", DragonSubType.Wyrm, [Affinity.Light], PortraitFactory.uPortraits("xenowyrm-pharos")),
    new DragonBreed("xenowyrm-pyro", "Xenowyrm (Pyro)", DragonSubType.Wyrm, [Affinity.Fire], PortraitFactory.uPortraits("xenowyrm-pyro")),
    new DragonBreed("xenowyrm-staterae", "Xenowyrm (Staterae)", DragonSubType.Wyrm, [Affinity.Neutral], PortraitFactory.uPortraits("xenowyrm-staterae")),
    new DragonBreed("xenowyrm-thalassa", "Xenowyrm (Thalassa)", DragonSubType.Wyrm, [Affinity.Water], PortraitFactory.uPortraits("xenowyrm-thalassa")),
    new DragonBreed("xenowyrm-umbra", "Xenowyrm (Umbra)", DragonSubType.Wyrm, [Affinity.Dark], PortraitFactory.uPortraits("xenowyrm-umbra")),
