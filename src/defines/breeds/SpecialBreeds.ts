...
let SpecialBreeds: Array<Breed> = [
    new Breed("tinsel-dragon", "Tinsel Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", [
    ...
    new Breed("shimmer-scale-dragon", "Shimmer-scale Dragon", DragonType.Dragon, DragonSubType.Eastern, "mf-mf", [
    ...
    new Breed("valentine-dragon", "Valentine Dragon", DragonType.Dragon, DragonSubType.Western, "f-f", [
    ...
    new Breed("sweetling-dragon", "Sweetling", DragonType.Dragon, DragonSubType.Wingless, "m-m", [
    ...
    new Breed("rosebud-dragon", "Rosebud Dragon", DragonType.Dragon, DragonSubType.Western, "f-f", [
    ...
    new Breed("heartseeker-dragon", "Heartseeker Dragon", DragonType.Dragon, DragonSubType.Western, "m-m", [
    ...
    new Breed("arsani-dragon", "Arsani Dragon", DragonType.Dragon, DragonSubType.Western, "f-f", [
    ...
    new Breed("radiant-angel-dragon", "Radiant Angel Dragon", DragonType.Dragon, DragonSubType.Western, "m-m", [
    ...
    new Breed("heartstealing-dragon", "Heartstealing Dragon", DragonType.Dragon, DragonSubType.Eastern, "f-f", [
    ...
    new Breed("mutamore-dragon", "Mutamore Dragon", DragonType.Dragon, DragonSubType.Western, "m-m", [
    ...
    new Breed("soulstone-dragon", "Soulstone Dragon", DragonType.Dragon, DragonSubType.Western, "f-f", [
        PortraitFactory.customPortrait('soulstone-f', "Standard", true),
    ]),
    new Breed("floral-crowned-dragon", "Floral-Crowned Dragon", DragonType.Dragon, DragonSubType.Western, "m-m", [
    ...
    new Breed("sakuhana-wyvern", "Sakuhana Wyvern", DragonType.Dragon, DragonSubType.Wyvern, "f-f", [
    ...
    new Breed("erador-lindwyrm", "Erador Lindwyrm", DragonType.Dragon, DragonSubType.Lindwyrm, "m-m", [
    ...
    new Breed("holly-dragon", "Holly Dragon", DragonType.Dragon, DragonSubType.Western, "m-mf", [
        PortraitFactory.customPortrait('holly-u', "Standard", true),
    ]),
    new Breed("yulebuck-dragon", "Yulebuck Dragon", DragonType.Dragon, DragonSubType.Western, "m-m", [
        PortraitFactory.customPortrait('yulebuck-m', "Standard", true),
        PortraitFactory.customPortrait('yulebuck-salt-m', "Salt", false)
    ]),
    new Breed("snow-angel-dragon", "Snow Angel", DragonType.Dragon, DragonSubType.Western, "f-f", [
    ...
    new Breed("ribbon-dancer-dragon", "Ribbon Dancer", DragonType.Dragon, DragonSubType.Western, "f-f", [
    ...
    new Breed("winter-magi-dragon", "Winter Magi Dragon", DragonType.Dragon, DragonSubType.Western, "m-m", [
        PortraitFactory.customPortrait('winter-magi-m', "Standard", true),
        PortraitFactory.customPortrait('winter-magi-salt-m', "Salt", false)
    ]),
    new Breed("wrapping-wing-dragon", "Wrapping-Wing", DragonType.Dragon, DragonSubType.Western, "m-m", [
    ...
    new Breed("solstice-dragon", "Solstice Dragon", DragonType.Dragon, DragonSubType.Western, "f-f", [
        PortraitFactory.customPortrait('solstice-f', "Standard", true),
        PortraitFactory.customPortrait('solstice-salt-f', "Salt", false),
    ]),
    new Breed("mistletoe-dragon", "Mistletoe Dragon", DragonType.Dragon, DragonSubType.Western, "f-mf", [
    ...
    new Breed("aegis-dragon", "Aegis Dragon", DragonType.Dragon, DragonSubType.Wingless, "m-m", [
    ...
    new Breed("snow-dragon", "Snow Dragon", DragonType.Dragon, DragonSubType.Western, "m-m", [
    ...
    new Breed("garland-dragon", "Garland Dragon", DragonType.Dragon, DragonSubType.Amphiptere, "f-f", [
    ...
    new Breed("starsinger-dragon", "Starsinger Dragon", DragonType.Dragon, DragonSubType.Western, "f-f", [
    ...
    new Breed("wintertide-dragon", "Wintertide Dragon", DragonType.Dragon, DragonSubType.Amphiptere, "m-m", [
    ...
    new Breed("pumpkin-dragon", "Pumpkin Dragon", DragonType.Pygmy, DragonSubType.Western, "mf-mf", [
        PortraitFactory.customPortrait('pumpkin-u', "Standard", true),
        PortraitFactory.customPortrait('pumpkin-salt-u', "Salt", false)
    ]),
    new Breed("black-marrow-dragon", "Black Marrow Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", PortraitFactory.mfPortraits("black-marrow")),
    new Breed("shadow-walker-dragon", "Shadow Walker Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", [
    ...
    new Breed("cavern-lurker-dragon", "Cavern Lurker Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", [
    ...
    new Breed("grave-dragon", "Grave Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", [
    ...
    new Breed("desipis-dragon", "Desipis Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", [
    ...
    new Breed("caligene-dragon", "Caligene Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", [
    ...
    new Breed("witchlight-dragon", "Witchlight Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", [
    ...
    new Breed("omen-wyrm", "Omen Wyrm", DragonType.Dragon, DragonSubType.Wyrm, "mf-mf", [
    ...
    new Breed("arcana-dragon", "Arcana Dragon", DragonType.Dragon, DragonSubType.Western, "mf-mf", [
    ...
    new Breed("kohraki-dragon", "Kohraki Dragon", DragonType.Dragon, DragonSubType.Wyvern, "mf-mf", [
